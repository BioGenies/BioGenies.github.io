...
`r fontawesome::fa("location-dot", fill = "pink", height = "1em")` **Place**: Remotely or at Bioinformatics and Multiomics Analyses Laboratory, Clinical Research Centre, Medical University of Białystok, Poland

`r fontawesome::fa("sack-dollar", fill = "pink", height = "1em")` **Scholarship/salary**: 2500 PLN per month (tax-free for students under 26 yo)

`r fontawesome::fa("hourglass-start", fill = "pink", height = "1em")` **Planned start date for project work**: 01.10.2024

### `r fontawesome::fa("calendar", fill = "black", height = "1.5em")` Important dates

`r fontawesome::fa("hourglass-end", fill = "pink", height = "1em")` **Submission deadline**: 06.09.2024, 15:00 (GMT+2)

`r fontawesome::fa("comments", fill = "pink", height = "1em")` **Interviews (Google Meet)**: 16-17.09.2024

## Tasks and skills

### `r fontawesome::fa("graduation-cap", fill = "black", height = "1.5em")` student 1
...
### `r fontawesome::fa("graduation-cap", fill = "black", height = "1.5em")` student 2
