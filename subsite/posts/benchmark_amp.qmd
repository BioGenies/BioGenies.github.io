---
title: "Are AMP models lying to us? 🤖🧬 The benchmarking problem"
description: "A large-scale study reveals that antimicrobial peptide predictors are heavily biased due to how negative datasets are constructed."
date: "09/01/2022"
categories:
  - publications
  - peptides
keywords: ["AMP", "machine learning", "benchmarking", "negative dataset", "bias", "bioinformatics", "reproducibility"]
...
<audio controls>
  <source src="../audio/benchmark_amp.m4a" type="audio/x-m4a">
...
![](../fig/posts/publications/benchmark_amp.jpeg){fig-align="center" width='1200'}
