...
[`r fontawesome::fa("envelope", prefer_type = "regular", fill = "pink", height = "3em")`](jaroslaw.chilimoniuk@umb.edu.pl)
...
[`r fontawesome::fa("linkedin", fill = "#0077b5", height = "3em")`](https://www.linkedin.com/in/jaros%C5%82aw-chilimoniuk-1a2ab7311)
