...
👉 [HaDeX2: multi-dimensional analysis of hydrogen–deuterium exchange mass spectrometry data](https://academic.oup.com/bioinformatics/article/42/3/btag128/8524920)
...
- [🌐 Web server](https://hadex2.mslab-ibb.pl/)
...
- **Output:** statistical analysis, visualization, structural mapping

# 🏷️ Keywords

HDX-MS, hydrogen–deuterium exchange, mass spectrometry, protein dynamics, structural proteomics, bioinformatics software, R package, reproducible analysis, multi-dimensional data, protein structure
